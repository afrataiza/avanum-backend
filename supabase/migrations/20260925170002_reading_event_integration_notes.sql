-- ATSA-14 compatibility note:
-- Existing achievement integration remains active through database triggers.
-- Reading domain events coexist with those triggers and are not used to re-grant achievements.
